...
export default function Disclaimer() {
  return (
    <div className="container small-container">
      <h1 className="title">Disclaimer for SMA</h1>

      <div className="about">
        <p>
          If you require any more information or have any questions about our
          site's disclaimer, please feel free to contact us by email at
          gogodeetsauce@gmail.com. Our Disclaimer was generated with the help of
          the{' '}
        ...
        <h2>Disclaimers for deetsauce</h2>

        <p>
          All the information on this website - https://deetsauce.com/ - is
          published in good faith and for general information purpose only.
          deetsauce does not make any warranties about the completeness,
          reliability and accuracy of this information. Any action you take upon
          the information you find on this website (deetsauce), is strictly at
          your own risk. deetsauce will not be liable for any losses and/or
