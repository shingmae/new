...
export default function TermsAndCondition() {
  return (
    <div className="container small-container">
      <h1 className="title">Terms and Condition for SMA</h1>

      <div className="about">
        <h2>Welcome to deetsauce!</h2>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of SMA's Website, located at https://deetsauce.com/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use deetsauce if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing deetsauce, you agreed to
          use cookies in agreement with the SMA's Privacy Policy.{' '}
        </p>
        ...
        <p>
          Unless otherwise stated, SMA and/or its licensors own the intellectual
          property rights for all material on deetsauce. All intellectual
          property rights are reserved. You may access this from deetsauce for
        ...
        <p>You must not:</p>
        <ul>
          <li>Republish material from deetsauce</li>
          <li>Sell, rent or sub-license material from deetsauce</li>
          <li>Reproduce, duplicate or copy material from deetsauce</li>
          <li>Redistribute content from deetsauce</li>
        </ul>
        ...
        <p>
          ...
          exchange opinions and information in certain areas of the website. SMA
          ...
          opinions of SMA,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, SMA shall not be liable for
        ...
        <p>
          SMA reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant SMA a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of SMA; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to SMA. Please include your name, your organization
        ...
        <p>
          No use of SMA's logo or other artwork will be allowed for linking
